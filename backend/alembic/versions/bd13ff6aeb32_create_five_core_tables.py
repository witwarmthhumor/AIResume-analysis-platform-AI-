...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_analyses_anonymous_id"), "analyses", ["anonymous_id"], unique=False
    )
    op.create_index(
        op.f("ix_analyses_resume_id"), "analyses", ["resume_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "final_report_json", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index(
        op.f("ix_interview_sessions_anonymous_id"),
        "interview_sessions",
        ["anonymous_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_resumes_anonymous_id"), "resumes", ["anonymous_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_usage_logs_anonymous_id"), "usage_logs", ["anonymous_id"], unique=False
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_interview_sessions_resume_id"), table_name="interview_sessions"
    )
    op.drop_index(
        op.f("ix_interview_sessions_anonymous_id"), table_name="interview_sessions"
    )
    op.drop_table("interview_sessions")
    op.drop_index(
        op.f("ix_interview_messages_session_id"), table_name="interview_messages"
    )
